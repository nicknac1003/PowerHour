...
namespace Polarith.AI.Package
{
    ...
    public class VehiclePhysics : MonoBehaviour
    {
        ...
        private void ApplyDrive(float acceleration, float brake)
        {
            ...
            if (body.linearVelocity.magnitude > 1 && Vector3.Angle(transform.forward, body.linearVelocity) < 50f)
            {
        ...
        private void ApplySteerHelper()
        {
            ...
            if (Mathf.Abs(oldRotation - transform.eulerAngles.y) < 10.0f)
            {
                ...
                body.linearVelocity = velRotation * body.linearVelocity;
            }
        ...
        private void CapSpeed()
        {
            ...
            speed *= 3.6f;
            if (speed > Topspeed)
                body.linearVelocity = (Topspeed / 3.6f) * body.linearVelocity.normalized;
        }
